...
async fn add_nestded_joined_results() -> usize {
    let results = join!(
        ...
        ready(join!(ready(join!(ready(9usize)).0)).0)
    );
...
async fn add_nested_custom_joined_results() -> usize {
    let results = join_all!(
        ready(join_all!(ready(7usize)).0),
        ready(join_all!(ready(8usize)).0),
        ready(join_all!(ready(join_all!(ready(9usize)).0)).0)
    );
    results.0 + results.1 + results.2
}
...
async fn add_nested_custom_joined_x2_results() -> usize {
    let results = join_all_x2!(
        ready(join_all_x2!(ready(7usize)).0),
        ready(join_all_x2!(ready(8usize)).0),
        ready(join_all_x2!(ready(join_all_x2!(ready(9usize)).0)).0)
    );
    results.0 + results.1 + results.2
}
...
async fn add_nested_custom_joined_combined_results() -> usize {
    let results = join_all_x2!(
        ready(join_all!(ready(7usize)).0),
        ready(join_all_x2!(ready(8usize)).0),
        ready(join_all!(ready(join_all_x2!(ready(9usize)).0)).0)
    );
    results.0 + results.1 + results.2
}
